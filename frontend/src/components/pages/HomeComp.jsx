  ...
  return (
    <>
      ...
      <div className="conference-area pt-100 pb-100">
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="single-conference-content" data-cue="slideInRight">
      ...
      {/* <!-- Start Conference Planning Area --> */}
        <div className="conference-planning-area pb-70">
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-4 col-sm-6 col-md-6" data-cue="slideInLeft" data-duration="1000">
                    ...
                    <div className="col-lg-4 col-sm-6 col-md-6" data-cue="slideInDown" data-duration="1000">
                        <div className="single-conference-card">
                            <div className="planning-icon">
                    ...
                    <div className="col-lg-4 col-sm-6 col-md-6" data-cue="slideInRight" data-duration="1000">
                        <div className="single-conference-card">
                            <div className="planning-icon">
                ...
                <div className="conference-schedules-tab">
                    <ul className="nav nav-tabs">
                        <li className="nav-item" role="presentation">
                            <button className="nav-link active" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Day (1)</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Day (2)</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Day (3)</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" data-bs-toggle="tab" data-bs-target="#day-fore-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Day (4)</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" data-bs-toggle="tab" data-bs-target="#day-five-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Day (5)</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" data-bs-toggle="tab" data-bs-target="#day-six-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Day (6)</button>
                        </li>
                    </ul>
                    <div className="tab-content" id="myTabContent">
                        <div className="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                            <div className="conference-schedules-content"  data-cue="slideInUp">
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-lg-2">
                                        <div className="schedules-btn">
                                            <a href="pricing.html" className="default-btn btn-style-one">Buy A Tickets <i className='bx bx-plus'></i></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="tab-pane fade" id="day-fore-tab-pane" role="tabpanel" aria-labelledby="day-fore-tab" tabindex="0">
                            <div className="conference-schedules-content"  data-cue="slideInUp">
                                <div className="row align-items-center">
                                    <div className="col-lg-5">
                                        <div className="single-schedules-item">
                        ...
                        <div className="tab-pane fade" id="day-five-tab-pane" role="tabpanel" aria-labelledby="day-five-tab" tabindex="0">
                            <div className="conference-schedules-content"  data-cue="slideInUp">
                                <div className="row align-items-center">
                                    <div className="col-lg-5">
                                        <div className="single-schedules-item">
                        ...
                        <div className="tab-pane fade" id="day-six-tab-pane" role="tabpanel" aria-labelledby="day-six-tab" tabindex="0">
                            <div className="conference-schedules-content"  data-cue="slideInUp">
                                <div className="row align-items-center">
                                    <div className="col-lg-5">
                                        <div className="single-schedules-item">
        ...
        {/* <!-- Start Upcoming area --> */}
        <div className="upcoming-area pt-100 pb-100 jarallax" data-jarallax='{"speed": 0.3}'>
            <div className="container">
                <div className="section-title">
                ...
                <div className="upcoming-list">
                    <ul className="live-auctions-countdown flex-wrap d-flex justify-content-center">
                        <li className="align-items-center flex-column d-flex justify-content-center" data-cue="slideInRight">
                            <span className="days">00</span>
                            Days
                        </li>
                        <li className="align-items-center bgs-border-10 flex-column d-flex justify-content-center" data-cue="slideInRight">
                    ...
                    <div className="upcoming-btn">
                        <a href="register.html" className="default-btn">Register Now <i className='bx bx-plus' ></i></a>
                    </div>
                </div>
            </div>
                ...
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        <div className="why-the-conference-image">
                            <img src="assets/images/conference/why-the-conference-1.jpg" alt="images" data-cue="slideInDown"/>
                            <div className="why-the-conference-img-2" data-cue="slideInLeft">
                                <img src="assets/images/conference/why-the-conference-2.jpg" alt="images"/>
                            </div>
                            <div className="why-the-conference-img-3" data-cue="slideInUp">
                                <img src="assets/images/conference/why-the-conference-3.jpg" alt="images"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6" data-cue="slideInRight">
                        <div className="why-the-conference-content">
                            <div className="section-title left-title">
                                ...
                                form by injected humour or randomised words which don't look believable.</p>
                            </div>
                            <ul>
                                <li>
                                   <img src="assets/images/conference/why-the-conference-icon.svg" alt="images"/> We will provide a professional service every time.
                                </li>
                                <li>
                                    <img src="assets/images/conference/why-the-conference-icon.svg" alt="images"/> We will ensure that your event is accessible on all platforms and devices.
                                </li>
                                <li>
                                    <img src="assets/images/conference/why-the-conference-icon.svg" alt="images"/> We can set up your event for an unlimited audience.
                                </li>
                                <li>
                                    <img src="assets/images/conference/why-the-conference-icon.svg" alt="images"/> We complete event follow-ups to ensure a high customer retention rate.
                                </li>
                                <li>
                                    <img src="assets/images/conference/why-the-conference-icon.svg" alt="images"/> We only use very good tools that ensure a fast and safe experience.
                                </li>
                            </ul>
                            <a href="pricing.html" className="default-btn btn-style-one">Buy A Tickets <i className='bx bx-plus'></i></a>
                        </div>
        ...
        <div className="testimonials-area pb-70">
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-4 col-xl-3 col-sm-6 col-md-6" data-cue="slideInLeft">
                    ...
                    <div className="col-lg-4 col-xl-3 col-sm-6 col-md-6" data-cue="slideInUp">
                        <div className="testimonials-card">
                    ...
                    <div className="col-lg-4 col-xl-3 col-sm-6 col-md-6" data-cue="slideInDown">
                        <div className="testimonials-card">
                    ...
                    <div className="col-lg-4 col-xl-3 col-sm-6 col-md-6" data-cue="slideInRight">
                        <div className="testimonials-card">
                ...
                <div className="row align-items-center">
                    <div className="col-lg-12 col-xl-4">
                        <div className="single-blog-left-content">
                            ...
                            <a href="blog-details.html" className="default-btn btn-style-one">More Articles <i className='bx bx-plus'></i></a>
                        </div>
                    </div>
                            ...
                            <div className="row">
                                <div className="col-lg-6 col-md-6"> 
                                    <div className="blog-image">
                                        ...
                                        <img src="assets/images/blog/blog-2.jpg" className="blog-img1" alt="about-image"/>
                                        <img src="assets/images/blog/blog-3.jpg" className="blog-img2" alt="about-image"/>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-md-6">
                                        ...
                                        <ul>
                                            <li>
                                                <div className="single-hover-content">
                                                    ...
                                                    <a href="blog-details.html" className="read-more">Read More<i className="bx bx-plus"></i></a>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="single-hover-content">
        ...
        <div className="location-conference-area pt-100 pb-100">
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-4 col-md-6" data-cue="fadeIn" data-duration="2000">
                        <form className="location-conference-form">
                            ...
                            <div className="row">
                                    ...
                                    <div className="form-group">
                                        <div className="select-icon">
                                            <select className="form-select" aria-label="Default select example">
                                                <option selected>Number Of Ticket</option>
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        <input type="message" rows="3" className="form-control" placeholder="Your Message"/>
                                    </div>
                                </div>
                                <div className="col-lg-12">
                                    <button type="submit" className="default-btn btn-style-one">Buy A Tickets <i className='bx bx-plus' ></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div className="col-lg-4 col-md-6" data-cue="fadeIn" >
                        <div className="location-image">
                            ...
                            <div className="location-shape" data-cue="zoomIn" data-duration="2000">
                    ...
                    <div className="col-lg-4 col-md-6" data-cue="fadeIn" data-duration="2000">
                        <div className="location-branch-card">
                            ...
                            <a href="contact.html" className="default-btn">Get Directions <i className='bx bx-plus' ></i></a>
                        </div>
                    </div>
                </div>
            </div>
